...
@Composable
fun MiMapa(){
    val singapore = LatLng(42.649153, 13.003204)
...
fun DrawingonMaps(){
    GoogleMap(
        ...
        AdvancedMarker(
            state = MarkerState(position = LatLng(42.64, 13.003)),
            title = "Marker in Italy"
        )
        AdvancedMarker(
            state = MarkerState(position = LatLng( 43.75, 7.15)),
            title = "Marker in Monaco"
        )
        AdvancedMarker(
            state = MarkerState(position = LatLng( 47.31,  8.26)),
            title = "Marker in Suiza"
        )
    }
}
